...
class MissingAndRepeatingNumFinder {
	...
	public int findDuplicateNumber(int[] pInputArray) {
		...
		for(int loopIndex = 0; loopIndex < totalNumbers ; loopIndex++) {
			...
			//System.out.println("pInputArray[loopIndex] : "+pInputArray[loopIndex]);
			if(inputList.contains(pInputArray[loopIndex])){
				duplicateNumber = pInputArray[loopIndex];
			}
			else {
