 ...
 * 
 * This program is a solution for pascal triangle problem. 
 * Please find the leetcode question given below for which we're trying to find a solution
...
public class PascalTriangleTester2 {
	...
	public static void main(String[] args) {
		...
		int pascalTriangleSize = 3;
		PascalTriangleRowGenerator triangleRowGenerator = new PascalTriangleRowGenerator();
		ArrayList<Integer> pascalTriangle = triangleRowGenerator.getRow(pascalTriangleSize);
...
class PascalTriangleRowGenerator {
	...
	public void displayPascalTriangle(ArrayList<Integer> pPascalTriangle) {
